...
public class MoodAnalyserTest {
    ...
    // Test7.1:Set happy message with reflector should return Happy
    @Test
    public void givenSetHappyMessageWithReflector_ShouldReturnHAPPY() throws MoodAnalyserException {
        try {
